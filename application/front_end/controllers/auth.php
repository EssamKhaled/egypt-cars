...
class auth extends CI_Controller {
    ...
    function index() {
        if ($message = $this->session->flashdata('message')) {
            ...
            $return['first_content'] = $this->load->view('auth/general_message', array('message' => $message), TRUE);
        ...
        if ($this->tank_auth->is_logged_in()) {         // logged in
            ...
            if ($this->form_validation->run()) {        // validation ok
                if ($this->tank_auth->login(
                        ...
                        if($this->session->userdata('unsubmitted_order')){
                            $data = $this->session->userdata('unsubmitted_order');
                            $data['user'] = $this->session->userdata('user_id');
                            $this->db->insert('transfer_order', $data);
            ...
            $return['first_content'] = $this->load->view('auth/login_form', $data, TRUE);
            $return['second_content'] = '';
            $this->load->view('mainlayout', $return);
        }
    }
    ...
    function register() {
        if ($this->tank_auth->is_logged_in()) {         // logged in
            ...
            $return['first_content'] = $this->load->view('auth/register_form', $data, TRUE);
            $return['second_content'] = '';
            $this->load->view('mainlayout', $return);
        }
    }
    ...
    function forgot_password() {
        if ($this->tank_auth->is_logged_in()) {         // logged in
            ...
            $return['first_content'] = $this->load->view('auth/forgot_password_form', $data, TRUE);
            $return['second_content'] = '';
            $this->load->view('mainlayout', $return);
        }
    }
